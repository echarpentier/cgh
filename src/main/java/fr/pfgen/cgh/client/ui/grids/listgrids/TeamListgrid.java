...
public class TeamListgrid extends ListGrid {
	
	public TeamListgrid(){
		TeamDS datasource = TeamDS.getInstance();
		
		this.setTitle("List of teams.");
		...
		this.addSort(new SortSpecifier("team_id",SortDirection.DESCENDING));
	}
}
